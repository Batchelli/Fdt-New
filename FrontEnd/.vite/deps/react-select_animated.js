...
var AnimatedInput = function AnimatedInput2(WrappedComponent) {
  return function(_ref) {
    ...
    return React7.createElement(WrappedComponent, props);
  };
};
...
var Fade = function Fade2(_ref) {
  ...
  return React7.createElement(Transition_default, {
    mountOnEnter: true,
    unmountOnExit: true,
    in: inProp,
    timeout: duration,
    ...
    return React7.createElement(Tag, _extends({
      innerProps
    }, props));
  });
};
...
var Collapse = function Collapse2(_ref2) {
  ...
  var _useState = (0, import_react8.useState)("auto"), _useState2 = _slicedToArray(_useState, 2), width = _useState2[0], setWidth = _useState2[1];
...
var AnimatedMultiValue = function AnimatedMultiValue2(WrappedComponent) {
  return function(_ref) {
    ...
    return React7.createElement(Collapse, {
      in: inProp,
      onExited
    }, React7.createElement(WrappedComponent, _extends({
...
var AnimatedPlaceholder = function AnimatedPlaceholder2(WrappedComponent) {
  return function(props) {
    return React7.createElement(Fade, _extends({
...
var AnimatedValueContainer = function AnimatedValueContainer2(WrappedComponent) {
  return function(props) {
    return props.isMulti ? React7.createElement(IsMultiValueContainer, _extends({
      component: WrappedComponent
    }, props)) : React7.createElement(TransitionGroup_default, _extends({
      component: WrappedComponent
    }, props));
  };
};
var IsMultiValueContainer = function IsMultiValueContainer2(_ref) {
  ...
  return React7.createElement(TransitionGroup_default, _extends({
    component
  }, multiProps));
};
var useIsMultiValueContainer = function useIsMultiValueContainer2(_ref2) {
  ...
  var _useState = (0, import_react8.useState)(isMulti && controlShouldRenderValue && hasValue), _useState2 = _slicedToArray(_useState, 2), cssDisplayFlex = _useState2[0], setCssDisplayFlex = _useState2[1];
  var _useState3 = (0, import_react8.useState)(false), _useState4 = _slicedToArray(_useState3, 2), removingValue = _useState4[0], setRemovingValue = _useState4[1];
  (0, import_react8.useEffect)(function() {
  ...
  var childMapper = function childMapper2(child) {
    if (isMulti && React7.isValidElement(child)) {
  ...
  var newProps = _objectSpread2(_objectSpread2({}, props), {}, {
    ...
    children: React7.Children.toArray(children2).map(childMapper)
  });
  return newProps;
};
