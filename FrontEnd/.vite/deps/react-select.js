...
var LiveRegion = function LiveRegion2(props) {
  ...
  var messages = (0, import_react2.useMemo)(function() {
    return _objectSpread2(_objectSpread2({}, defaultAriaLiveMessages), ariaLiveMessages || {});
  }, [ariaLiveMessages]);
  var ariaSelected = (0, import_react2.useMemo)(function() {
    var message = "";
  ...
  var ariaFocused = (0, import_react2.useMemo)(function() {
    var focusMsg = "";
  ...
  var ariaResults = (0, import_react2.useMemo)(function() {
    var resultsMsg = "";
  ...
  var ariaGuidance = (0, import_react2.useMemo)(function() {
    var guidanceMsg = "";
  ...
  var ScreenReaderText = jsx(import_react2.Fragment, null, jsx("span", {
    id: "aria-selection"
  }, ariaSelected), jsx("span", {
    id: "aria-context"
  }, ariaContext));
  var isInitialFocus = (ariaSelection === null || ariaSelection === void 0 ? void 0 : ariaSelection.action) === "initial-input-focus";
  return jsx(import_react2.Fragment, null, jsx(A11yText$1, {
    id
...
function useScrollCapture(_ref3) {
  ...
  var isBottom = (0, import_react2.useRef)(false);
  var isTop = (0, import_react2.useRef)(false);
  var touchStart = (0, import_react2.useRef)(0);
  var scrollTarget = (0, import_react2.useRef)(null);
  var handleEventDelta = (0, import_react2.useCallback)(function(event, delta) {
  ...
  var onWheel = (0, import_react2.useCallback)(function(event) {
    handleEventDelta(event, event.deltaY);
  }, [handleEventDelta]);
  var onTouchStart = (0, import_react2.useCallback)(function(event) {
    touchStart.current = event.changedTouches[0].clientY;
  }, []);
  var onTouchMove = (0, import_react2.useCallback)(function(event) {
    var deltaY = touchStart.current - event.changedTouches[0].clientY;
    handleEventDelta(event, deltaY);
  }, [handleEventDelta]);
  var startListening = (0, import_react2.useCallback)(function(el) {
    if (!el)
      return;
  ...
  var stopListening = (0, import_react2.useCallback)(function(el) {
    if (!el)
      return;
...
function useScrollLock(_ref3) {
  ...
  var originalStyles = (0, import_react2.useRef)({});
  var scrollTarget = (0, import_react2.useRef)(null);
  var addScrollLock = (0, import_react2.useCallback)(function(touchScrollTarget) {
    if (!canUseDOM)
      return;
  ...
  var removeScrollLock = (0, import_react2.useCallback)(function(touchScrollTarget) {
    if (!canUseDOM)
      return;
    var target = document.body;
    var targetStyle = target && target.style;
...
function ScrollManager(_ref3) {
  ...
  return jsx(import_react2.Fragment, null, lockEnabled && jsx("div", {
  ...
  _createClass(Select2, [{
    ...
    value: (
      ...
      function renderInput() {
        ...
        return React.createElement(Input, _extends({}, commonProps, {
          autoCapitalize: "none",
          autoComplete: "off",
          autoCorrect: "off",
          id,
    ...
    value: function renderMenu() {
      ...
      var render = function render2(props, id) {
        ...
        return React.createElement(Option, _extends({}, commonProps, {
          innerProps,
          data,
          isDisabled,
          isSelected,
      ...
      if (this.hasOptions()) {
        menuUI = this.getCategorizedOptions().map(function(item) {
          if (item.type === "group") {
            ...
            return React.createElement(Group, _extends({}, commonProps, {
              key: groupId,
              data: _data,
              options,
      ...
      var menuElement = React.createElement(MenuPlacer, _extends({}, commonProps, menuPlacementProps), function(_ref4) {
        ...
        return React.createElement(Menu, _extends({}, commonProps, menuPlacementProps, {
          ...
          return React.createElement(MenuList, _extends({}, commonProps, {
...
var StateManagedSelect = (0, import_react4.forwardRef)(function(props, ref) {
...
var NonceProvider = function(_ref3) {
  ...
  var emotionCache = (0, import_react4.useMemo)(function() {
    return createCache({
      key: cacheKey,
      nonce
    });
